//
//  DoctorReservations.swift
//  DoctorX
//
//  Created by yasmeen on 8/19/19.
...
class DoctorReservations: UIViewController, UITableViewDelegate ,UITableViewDataSource {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.ref.child("Reservation").queryOrdered(byChild: "reserveTime").observeSingleEvent(of: .value, with: { (snapshot) in
            for child in snapshot.children {
                ...
                if confirmed == "1" && day == day1 && month == month1 && year == year1 && entered == "0"{
